...
const string programInfo = "\033[3m\033[1m\033[33mArk\033[32mCulator\033[0m\033[0m v5.1 | © 2022-2025 TRAYVED/AEYCEN | MIT License";
...
int main()
{
    try
    {
        ...
        while (true)
        {
            ...
            cout << ANSI_RED << "Invalid weapon type. Please enter 1, 2, 3, 4, 5 or 6." << ANSI_RESET << endl;
            cin.clear();
